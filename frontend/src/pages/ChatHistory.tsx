...
function ChatHistory() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white relative overflow-hidden">
      ...
      />
      <div className="absolute top-20 right-1/4 w-80 h-80 bg-violet-600 rounded-full blur-3xl opacity-10 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 pt-10 pb-16">
        ...
        <div className="flex items-center justify-between mb-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-xs mt-0.5">Your document conversations</p>
            </div>
          </div>
          <button
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-32 text-center">
            ...
            <p className="text-gray-500 text-sm mt-1 mb-6">Upload a document to start a conversation</p>
            <button
              onClick={() => navigate('/features')}
